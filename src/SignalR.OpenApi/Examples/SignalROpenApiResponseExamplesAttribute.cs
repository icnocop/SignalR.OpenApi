...
/// <summary>
/// Specifies an examples provider for the response of a SignalR hub method.
...
public sealed class SignalROpenApiResponseExamplesAttribute : Attribute
{
    /// <summary>
    /// Initializes a new instance of the <see cref="SignalROpenApiResponseExamplesAttribute"/> class.
    /// </summary>
    ...
    /// </param>
    public SignalROpenApiResponseExamplesAttribute(Type examplesProviderType)
    {
